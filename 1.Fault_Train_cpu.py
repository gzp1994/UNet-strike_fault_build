"""
Fault Detection by 3D SegNet
Fault detection by U-Net based 3D SegNet trained by a large number of synthetic seismic volumes. The methodology is described in Xinming Wu et al., 2019, Geophysics Vol 84 No. 3 This notebook starts from the synthetic seismic data generation part.

Create 1D reflection model
Apply Gaussian deformation
Apply planar deformation
Add fault throws
Convolve reflection model with a wavelet
Add some random noise
Extract the central part of the volume in the size of 128x128x128
